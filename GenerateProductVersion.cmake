...
function(generate_product_version outfiles)
    ...
    configure_file(
        ...
        @ONLY)
    if (CYGWIN)
      # Using a file windres.h (which is located in a directory
      # without spaces instead of Microsoft's winres.h
      include_directories("${GenerateProductVersionCurrentDir}" PARENT_SCOPE)
    endif()
